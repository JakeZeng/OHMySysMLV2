...
cd poc-v2\frontend
npx playwright test e2e/m15-screenshots --reporter=line   # 01–10
...
✅ 多视图复用同一元素，树中单一身份不复制
✅ Promote to Package：把 view-private 定义从 view body 移回所属包 body
...
`gates`：go build + go test 全绿 / tsc clean / vitest **203 passed (19 files)** / Playwright 7 passed。

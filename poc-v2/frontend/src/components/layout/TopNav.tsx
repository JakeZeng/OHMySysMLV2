...
import { LogOut, User as UserIcon, Settings, FolderKanban, Users, BookOpen, ScrollText, LayoutDashboard, Store, Webhook, Key, FileUp, FileText, Puzzle } from 'lucide-react';

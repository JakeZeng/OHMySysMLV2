...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('border-b border-gray-100 dark:border-gray-700 px-5 py-3', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('border-t border-gray-100 dark:border-gray-700 px-5 py-3', className)}
    {...props}
  />
));
